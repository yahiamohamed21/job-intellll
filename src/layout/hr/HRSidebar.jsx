...
const NAV_ITEMS = [
  { to: "/hr", key: "dashboard", icon: "dashboard", labelAr: "لوحة التحكم", labelEn: "Dashboard" },
  { to: "/hr/jobs", key: "jobs", icon: "work", labelAr: "الوظائف", labelEn: "Jobs" },
  { to: "/hr/candidates", key: "candidates", icon: "groups", labelAr: "المتقدمون", labelEn: "Candidates" },
  { to: "/hr/notifications", key: "notifications", icon: "notifications", labelAr: "الإشعارات", labelEn: "Notifications" },
  { to: "/hr/settings", key: "settings", icon: "settings", labelAr: "الإعدادات", labelEn: "Settings" },
];
...
const STORAGE_KEY = "jobintel.hr_sidebar.collapsed";
    ...
    return (
      <>
            ...
            {!collapsed && (
              <div className="flex flex-col items-start min-w-0 overflow-hidden">
                <span className="text-base sm:text-lg font-extrabold tracking-tight text-slate-800 dark:text-white truncate">
                  Job <span className="text-blue-600 dark:text-blue-400">Intel</span> <span className="opacity-80">HR</span>
                </span>
              </div>
            )}
          </button>
        ...
        <nav className="flex flex-col gap-2 flex-1" aria-label="Primary">
          {NAV_ITEMS.map(({ to, key, icon, labelAr, labelEn }, idx) => (
            <NavLink
              key={to}
              to={to}
              end={to === "/hr"}
              ...
              title={collapsed ? (isRtl ? labelAr : labelEn) : undefined}
      ...
      >
        <div className="px-4 sm:px-6 h-16 flex items-center justify-between gap-3">
          ...
          <button
            ...
            aria-controls="hr-mobile-drawer"
